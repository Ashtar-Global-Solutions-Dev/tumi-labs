...
const services = [
  {
    ...
    description: 'Production-grade Solana programs built with Anchor. We design, develop, audit-ready contracts for DeFi, NFTs, DAOs, and custom protocols.',
    features: [
  ...
  },
  {
    ...
    description: 'Full-stack decentralized applications with polished UIs, seamless wallet integration, and robust backend infrastructure.',
    features: [
  ...
  },
  {
    ...
    gradient: 'from-accent to-brand-frostbite',
  },
  {
    id: 'wallet-recovery',
...
const process = [
  {
    step: '01',
    title: 'Discovery',
    desc: 'We dive deep into your vision, requirements, and the technical landscape to define the optimal approach.',
  },
  {
    step: '02',
    title: 'Architecture',
    desc: 'Design the system architecture, smart contract structure, and technical stack tailored to your needs.',
  },
  {
    step: '03',
    title: 'Build',
  ...
  },
  {
    step: '04',
    title: 'Ship & Support',
    desc: 'Mainnet deployment, monitoring setup, and ongoing support to ensure your product thrives.',
  },
];
...
export default function Services() {
  return (
    <>
      <Head>
        <title>Services | TumiLabs</title>
        <meta name="description" content="Full-stack Solana development services — smart contracts, dApps, blockchain forensics, wallet recovery, DeFi, NFTs, AI integration, and technical consulting." />
      </Head>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
              ...
              <span className="gradient-text">Ship on Solana</span>
            </h1>
            <p className="text-lg text-gray-400 leading-relaxed">
              From smart contract architecture to blockchain forensics and wallet recovery,
              we deliver production-ready Web3 products and investigative services. Full-stack, end-to-end, built to scale.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-xl mx-auto">
              Tell us about your idea and we&rsquo;ll figure out the best way to bring it to life.
            </p>
            <Link
              href="/contact"
